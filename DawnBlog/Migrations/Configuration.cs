namespace DawnBlog.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<DawnBlog.DAL.DB>
    {
        public Configuration()
        {
            AutomaticMigrationsEnabled = false;
            ContextKey = "DawnBlog.DAL.DB";
        }

        protected override void Seed(DawnBlog.DAL.DB context)
        {
